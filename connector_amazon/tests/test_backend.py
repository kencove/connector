...
class TestAmazonBackend(common.CommonConnectorAmazonSpapi):
    ...
    def test_action_fetch_marketplaces_create_and_update(self, mock_request):
        ...
        existing_marketplace = self.env["amz.marketplace"].create(
            {
                "name": "Old US Name",
                "code": "US",
        ...
        updated = self.env["amz.marketplace"].browse(existing_marketplace.id)
        ...
        created = self.env["amz.marketplace"].search(
            [
    ...
    def test_backend_with_multiple_shops(self):
        ...
        shop2 = self._create_shop(
            ...
            marketplace_id=self.env["amz.marketplace"]
            .create(
                {
                    "name": "Amazon.co.uk",
                    "marketplace_id": "A1F83G7XSQSF3T",
