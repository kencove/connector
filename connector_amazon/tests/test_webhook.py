...
class TestWebhookController(CommonConnectorAmazonSpapi):
    ...
    def test_notification_log_model_exists(self):
        ...
        self.assertTrue(
            "amz.notification.log" in self.env,
            "amz.notification.log model should be registered",
        )
    ...
    def test_notification_log_process_order_change(self):
        ...
        amazon_order = self._create_amazon_order(external_id="111-1111111-1111111")
    ...
    def test_backend_webhook_url_computed(self):
        ...
        self.assertIn("/amz/webhook/", self.backend.webhook_url)
