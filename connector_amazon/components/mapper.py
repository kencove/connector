...
class AmazonOrderImportMapper(Component):
    _name = "amz.order.import.mapper"
    _inherit = "base.import.mapper"
    _usage = "import.mapper"
    _apply_on = ["amz.sale.order"]
    ...
    def map_marketplace(self, record):
        ...
        marketplace = self.env["amz.marketplace"].search(
            [
...
class AmazonOrderLineImportMapper(Component):
    _name = "amz.order.line.import.mapper"
    _inherit = "base.import.mapper"
    _usage = "import.mapper"
    _apply_on = ["amz.sale.order.line"]
...
class AmazonProductPriceImportMapper(Component):
    ...
    def map_competitive_price(self, pricing_data, product_binding):
        ...
        Args:
            ...
            product_binding: amz.product.binding record

        Returns:
            dict: Values for amz.competitive.price creation
        """
