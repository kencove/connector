...
class AmazonWebhookController(http.Controller):
    ...
    def _get_backend_by_token(self, token):
        ...
        Returns:
            amazon.backend record or None
        """
        if not token:
            return None

        return (
            request.env["amazon.backend"]
            .sudo()
    ...
    def _handle_notification(self, data, backend):
        ...
        try:
            ...
            return {"status": "ok", "message": f"Notification {notification_type} queued"}
    ...
    def _create_notification_log(
        ...
        Returns:
            amazon.notification.log record
        """
        try:
            return (
                request.env["amazon.notification.log"]
                .sudo()
                .create(
                    {
